...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 15, 2018 at 12:25 AM
...
('978-1-4919-3309-1', 'PHP Web Services: APIs for the Modern Web 2nd Edition', 'Lorna Jane Mitchell', 'php_web_services.jpg', 'Whether youï¿½re sharing data between two internal systems or building an API so that users can access their data, this practical guide has everything you need to build APIs with PHP. Author Lorna Jane Mitchell provides lots of hands-on code samples, real-world examples, and advice based on her extensive experience to guide you through the processï¿½from the underlying theory to methods for making your service robust.\r\n\r\nYouï¿½ll learn how to use this language to work with JSON, XML, and other web service technologies. This updated second edition includes new tools and features that reflect PHP updates and changes on the Web.', '1338.90', 2);
...
('admin', 'mikolit2283@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'admin'),
